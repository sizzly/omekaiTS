...
<!--Notes -->
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="flex-fill px-3">
                                <div class="fw-bold"><?php echo $description; ?></div>
                                <div class="small text-white text-opacity-50">Notes</div>
                            </div>
                        </div>
<!-- Tags -->
                        <div class="list-group-item d-flex align-items-center">
...
<!-- Date of Muster -->
                        <?php if (metadata($item, array('Dublin Core', 'Date'))) : ?>
                            <div class="list-group-item d-flex align-items-center">
                                ...
                                <div class="flex-fill px-3">
                                    <div class="fw-bold"><?php echo metadata($item, array('Dublin Core', 'Date')); ?></div>
                                    <div class="small text-white text-opacity-50">Date of Muster</div>
                                </div>
                            </div>
                        <?php endif; ?>
<!--End Meta -->
...
<!-- Lore Card -->
    <?php if (metadata($item, array('Item Type Metadata', 'Lore'))) : ?>
        <div class="card mb-3">
            <div class="card-header fw-bold small">Lore</div>
            <div class="card-body">
                <?php echo metadata($item, array('Item Type Metadata', 'Lore')); ?>
            </div>
            <div class="card-arrow">
                <div class="card-arrow-top-left"></div>
                <div class="card-arrow-top-right"></div>
